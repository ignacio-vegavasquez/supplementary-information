...
WD<-"C:/Users/Igveg/Desktop/Example/Normalization/Raw"
SD<-"C:/Users/Igveg/Desktop/Example/Normalization/Normalized"
X0<-"Sampling Example" 
...
DataBase<-as.data.frame(read_xlsx(path=XI))  #Creates a dataframe with list of files to analize and their sampling
