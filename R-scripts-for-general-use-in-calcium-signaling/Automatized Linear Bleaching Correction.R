...
WD<-"D:/Descargas/Example_folder_to_test_scripts/Example/Linear_bleaching_correction/Original"
SD<-"D:/Descargas/Example_folder_to_test_scripts/Example/Linear_bleaching_correction/Corrected"
...
#c(1,4,7,8,9,12) to evaluate the files n° 1, 4, 7, 8, 9 and 12. c(2:5) to evaluate files 2,3,4,5.
ToEvaluate<-c(0) 
